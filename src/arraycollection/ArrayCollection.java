...
public class ArrayCollection {
    ...
    public static void main(String[] args) {
        ...
        // 4.
        int[] myArray4 = new int[4];                // This is different, we are creating an array without initialised values
        ...
        // Challenge statement now; how to print out myCharArray in the reverse order (c, b, a)
        ...
        // At this time, there is no direct approach in sorting primitive types (e.g int) in REVERSE ORDER
