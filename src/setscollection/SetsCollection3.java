...
class SetsCollection3 {
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> union = new HashSet<>(setA);           // need to obtain the 1st dataset to refer to
        ...
        difference.removeAll(setB);                         // output the difference between setA's data and setB's data
