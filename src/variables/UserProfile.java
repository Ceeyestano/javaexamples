...
public class UserProfile {
    ...
    int age;                    // age (int)
    GENDER_TYPE gender;         // gender (GENDER_TYPE)
    String jobPreference;       // job preference (String)
    String nationality;         // nationality (String)
    String bloodType;           // blood type (String)
